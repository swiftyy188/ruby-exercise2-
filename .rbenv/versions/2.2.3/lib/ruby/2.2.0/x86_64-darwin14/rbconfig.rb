...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/swifty/.rbenv/versions/2.2.3")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/swifty/.rbenv/versions/2.2.3' '--with-openssl-dir=/usr/local/opt/openssl' 'CC=clang' 'CFLAGS= -O3 -Wno-error=shorten-64-to-32 ' 'LDFLAGS=-L/Users/swifty/.rbenv/versions/2.2.3/lib ' 'CPPFLAGS=-I/Users/swifty/.rbenv/versions/2.2.3/include '"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/swifty/.rbenv/versions/2.2.3"
  ...
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/Users/swifty/.rbenv/versions/2.2.3/include  -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/Users/swifty/.rbenv/versions/2.2.3/lib  -fstack-protector"
